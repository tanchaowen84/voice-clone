...
export function WaveAudioPlayer({ src, className, height = 72 }: WaveAudioPlayerProps) {
  ...
  return (
    <div className={cn("rounded-md border p-3", className)}>
      ...
      <div className="mt-3 flex items-center justify-between">
        <Button variant="outline" size="sm" onClick={togglePlay} disabled={!isReady} aria-label={isPlaying ? "Pause" : "Play"}>
