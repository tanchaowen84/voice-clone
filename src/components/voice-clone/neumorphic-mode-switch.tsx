        ...
        <div className="relative bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-2 shadow-[8px_8px_16px_#d1d5db,-8px_-8px_16px_#ffffff] dark:shadow-[8px_8px_16px_#1e293b,-8px_-8px_16px_#334155]">
          ...
          <div className="relative flex">
            ...
            <motion.button
              ...
              className={`
                relative flex items-center justify-center gap-3 py-3 rounded-xl text-base font-medium transition-all duration-300 z-10 w-30
                ${
                  inputMode === 'record'
            ...
            <motion.button
              ...
              className={`
                relative flex items-center justify-center gap-3 py-3 rounded-xl text-base font-medium transition-all duration-300 z-10
                ${
                  inputMode === 'upload'
